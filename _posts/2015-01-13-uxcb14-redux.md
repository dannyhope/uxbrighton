...
Sophie will be talking about how introverts and extroverts approach UX and how that effects the process. Sophie is a UX Architect / Front End Developer who has worked in a variety of fast paced digital agencies. She has turned her hand to UX over the past few years, concentrating on delivering experiences that are focused around what the user needs. Sophie recently set up and co-organises the London group of [Ladies That UX](http://www.ladiesthatux.com/ "").
